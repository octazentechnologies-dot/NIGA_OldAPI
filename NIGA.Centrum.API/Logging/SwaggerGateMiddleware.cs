...
namespace NIGA.Centrum.API.Logging
{
    ...
    public sealed class SwaggerGateMiddleware
    {
        ...
        private async Task ServeLoginAsync(HttpContext context)
        {
            ...
            await context.Response.WriteAsync(Niga_Domain_Page(error));
        }

        private string Niga_Domain_Page(string error)
        {
    ...
    public static class SwaggerLoginHtml
    {
        public static string Page(string apiName, string error)
        {
            ...
            return "<!DOCTYPE html><html lang=\"en\"><head><meta charset=\"utf-8\">"
                ...
                + "<title>" + System.Net.WebUtility.HtmlEncode(apiName) + "</title><style>"
